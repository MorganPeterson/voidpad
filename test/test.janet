...
(defn tests
  ...
  (test "queries"
        ...
        (expect (vp-gap-size buf2) 1)
        (expect (vp-all-size buf1) 4) 
        (expect (vp-all-size buf2) 14)
        (expect (vp-gap-offset buf1) 0)
        (expect (vp-gap-offset buf2) 13)
        (expect (vp-aft-offset buf1) 3)
        (expect (vp-aft-offset buf2) 13)
        ...
        (expect (string/from-bytes (vp-char-before buf2 6)) ",")
